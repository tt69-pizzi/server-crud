...
// ---GET users page. with cache--- //
router.get('/', function (req, res, next) {
      res.render("users/list",
       { title: 'users', message: 'Request for users received', date: new Date() });
  });
/*
// SHOW LIST OF USERS
router.get('/', function (req, res, next) {
    pool.query('SELECT * FROM users ORDER BY id DESC', function (err, rows, fields) {
        //if(err) throw err
        if (err) {
            req.flash('error', err);
            res.render('users/list', {
